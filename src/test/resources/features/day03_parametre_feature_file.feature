...
Feature: arama_feature
  ...
  Scenario: TC04_google_porcelain_tea_pot_arama
    When kullanici "porcelain_tea_pot" için arama yapar
    Then sonuclarin "porcelain_tea_pot" icerdigini dogrula
    Then close the application
...
#   "veri" --> feature file i parametrize etmek icin kullanilir (shift + ")
#
